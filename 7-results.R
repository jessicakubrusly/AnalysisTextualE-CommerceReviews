...
IMP=sort(RF500$importance[,3])
x1_500 = IMP[(length(IMP)):(length(IMP)-9)]
y1_500 = names(x1_100)


x2_100 = summary.gbm(GBM100)$rel.inf[1:10]
y2_100 = summary.gbm(GBM100)$var[1:10]

x2_300 = summary.gbm(GBM300)$rel.inf[1:10]
y2_300 = summary.gbm(GBM300)$var[1:10]

x2_500 = summary.gbm(GBM500)$rel.inf[1:10]
y2_500 = summary.gbm(GBM500)$var[1:10]



importance_matrix = xgb.importance(
  XGBoost_100$feature_names, model = XGBoost_100)
y3_100 = importance_matrix[1:10,1][[1]]
x3_100 = importance_matrix[1:10,2][[1]]

importance_matrix = xgb.importance(
  XGBoost_300$feature_names, model = XGBoost_300)
y3_300 = importance_matrix[1:10,1][[1]]
x3_300 = importance_matrix[1:10,2][[1]]

importance_matrix = xgb.importance(
  XGBoost_500$feature_names, model = XGBoost_500)
...
lista_modelos = list(CT,
                     RF100,RF300,RF500,
                     GBM100,GBM300,GBM500,
                     XGBoost_100,XGBoost_300,XGBoost_500)
